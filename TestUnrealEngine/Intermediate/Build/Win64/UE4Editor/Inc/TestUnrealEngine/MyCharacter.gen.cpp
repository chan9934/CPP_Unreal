...
// Cross Module References
	TESTUNREALENGINE_API UClass* Z_Construct_UClass_AMyCharacter_NoRegister();
	TESTUNREALENGINE_API UClass* Z_Construct_UClass_AMyCharacter();
	ENGINE_API UClass* Z_Construct_UClass_ACharacter();
	UPackage* Z_Construct_UPackage__Script_TestUnrealEngine();
	ENGINE_API UClass* Z_Construct_UClass_UAnimMontage_NoRegister();
	ENGINE_API UClass* Z_Construct_UClass_USpringArmComponent_NoRegister();
	ENGINE_API UClass* Z_Construct_UClass_UCameraComponent_NoRegister();
	TESTUNREALENGINE_API UClass* Z_Construct_UClass_UMyAnimInstance_NoRegister();
	ENGINE_API UClass* Z_Construct_UClass_UStaticMeshComponent_NoRegister();
	TESTUNREALENGINE_API UClass* Z_Construct_UClass_UMyStatComponent_NoRegister();
...
// End Cross Module References
	...
	IMPLEMENT_CLASS(AMyCharacter, 3416163672);
	template<> TESTUNREALENGINE_API UClass* StaticClass<AMyCharacter>()
	{
		return AMyCharacter::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMyCharacter(Z_Construct_UClass_AMyCharacter, &AMyCharacter::StaticClass, TEXT("/Script/TestUnrealEngine"), TEXT("AMyCharacter"), false, nullptr, nullptr, nullptr);
